...
public class TaxBeans extends org.apache.struts.action.ActionForm {
    ...
    String errIncome="",errAge="";

    public String getErrAge() {
        return errAge;
    }

    public void setErrAge(String errAge) {
        this.errAge = errAge;
    }

    public String getErrIncome() {
        return errIncome;
    }

    public void setErrIncome(String errIncome) {
        this.errIncome = errIncome;
    }
